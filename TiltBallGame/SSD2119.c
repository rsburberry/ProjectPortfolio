...
void LCD_GPIOInit(void){
  ...
  gpio_init_pin(0xB0, OUTPUT);
  gpio_init_pin(0xB1, OUTPUT);
  gpio_init_pin(0xB2, OUTPUT);
  gpio_init_pin(0xB3, OUTPUT);
  gpio_init_pin(0xB4, OUTPUT);
  gpio_init_pin(0xB5, OUTPUT);
  gpio_init_pin(0xB6, OUTPUT);
  gpio_init_pin(0xB7, OUTPUT);
  gpio_init_pin(0xA4, OUTPUT);
  gpio_init_pin(0xA5, OUTPUT);
  gpio_init_pin(0xA6, OUTPUT);
  gpio_init_pin(0xA7, OUTPUT);
